...
public class MapsActivityACP extends FragmentActivity implements OnMapReadyCallback, StepDetectionHandler.StepDetectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapsacp);
